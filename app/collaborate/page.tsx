		...
		<div>
			...
			<AngledRectangle>
				<p className={styles.text}>
					...
					donations, donated materials, or services. Contributions are
					invaluable in helping us cover expenses for workshops, outreach
					events, student competitions, and other activities that directly
					benefit our members.
				</p>
			</AngledRectangle>
				...
				<div className={styles.list}>
					<div className={styles.row}>
						...
						<div className={styles.textContainer}>
							...
							<p className={styles.rowText}>
								Offer limited-time discounts or share a percentage of profits
								with our organization. In return, we'll direct our members to
								explore and support your business
							</p>
						</div>
					</div>
					<div className={styles.row}>
						...
						<div className={styles.textContainer}>
							...
							<p className={styles.rowText}>
								Contribute your products to our students or events and receive
								exposure and recognition across our social media platforms and
								event promotions.
							</p>
						</div>
					</div>
					<div className={styles.row}>
						...
						<div className={styles.textContainer}>
							...
							<p className={styles.rowText}>
								Partner with us on a mutually agreed-upon project, with monetary
								compensation provided, allowing us to deliver value tailored to
								your business goals.
							</p>
						</div>
					</div>
					<div className={styles.row}>
						...
						<div className={styles.textContainer}>
							...
							<p className={styles.rowText}>
								Provide financial support to our organization in exchange for
								exposure, social media shoutouts, and the opportunity to feature
								your logo on our website, event materials, or product.
							</p>
						</div>
					</div>
				</div>
